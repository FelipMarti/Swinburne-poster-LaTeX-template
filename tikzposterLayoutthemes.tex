...
\definelayouttheme{Swinburne}{
    \usecolorstyle[colorPalette=Swinburne]{Default}%{Germany}
    \usebackgroundstyle{Rays}
    \usetitlestyle{Swinburne}%{Envelope}%{VerticalShading}
    \useblockstyle{Swinburne}
    \useinnerblockstyle{Default}
    \usenotestyle{Sticky}
}
